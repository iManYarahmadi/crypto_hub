...
import 'package:cryptohub/features/home/sub_modules/currency/domain/entities/currency_entity.dart' show CurrencyEntity;
import 'package:cryptohub/features/home/sub_modules/currency/domain/repositories/currency_repository.dart' show CurrencyRepository;
import 'package:cryptohub/features/home/sub_modules/currency/domain/usecases/currency_usecase.dart' show GetCurrenciesUseCase;
...
void main() {
  ...
  var mockCurrencies = [
    CurrencyEntity(
      ...
      name: 'Bitcoin',
      price: 50000.0,
      symbol: 'BTC', iconAddress: '',
    ),
    CurrencyEntity(
      id: 2,
      name: 'Ethereum',
      price: 3000.0,
      symbol: 'ETH', iconAddress: '',
    ),
  ];

  var mockFailure = ServerFailure('Failed to fetch currencies');

  test('getCurrenciesUseCase should return list of CurrencyEntity on success', () async {
    // Arrange
