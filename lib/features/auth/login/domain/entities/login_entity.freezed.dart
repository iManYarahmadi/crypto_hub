...
abstract class $LoginEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: 'authToken') String token});
}
...
class _$LoginEntityImpl implements _LoginEntity {
  const _$LoginEntityImpl({@JsonKey(name: 'authToken') this.token = ''});
  ...
  Map<String, dynamic> toJson() {
    return _$$LoginEntityImplToJson(this);
  }
}

abstract class _LoginEntity implements LoginEntity {
  const factory _LoginEntity({@JsonKey(name: 'authToken') final String token}) =
      _$LoginEntityImpl;
