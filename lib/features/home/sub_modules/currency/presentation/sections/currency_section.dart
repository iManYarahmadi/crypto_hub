...
import 'package:cryptohub/features/home/sub_modules/currency/sub_modules/get_favorite_currency/presentation/blocs/login/get_favorite_currencies_event.dart';
import 'package:cryptohub/features/home/sub_modules/currency/sub_modules/get_favorite_currency/presentation/blocs/login/get_favorite_currencies_state.dart';
...
class CurrencySection extends StatelessWidget {
  ...
  void _showSnackBar(BuildContext context, String message, {required bool isSuccess}) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          message,
          style: TextStyle(color: isSuccess ? theme.colorScheme.onPrimary : theme.colorScheme.onError),
        ),
  ...
  void _refreshData(BuildContext context) {
    context.read<GetFavoriteCurrenciesBloc>().add(const GetFavoriteCurrenciesEvent.fetchFavoriteCurrencies());
    context.read<CurrencyBloc>().add(const CurrencyEvent.fetchCurrencies());
  }

  void _toggleFavorite(BuildContext context, CurrencyEntity currency, int? favoriteId) {
