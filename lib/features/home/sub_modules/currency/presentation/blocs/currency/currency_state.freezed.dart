...
class __$$LoadedImplCopyWithImpl<$Res>
  ...
  @override
  $Res call({Object? currencies = null}) {
    return _then(
      _$LoadedImpl(
        null == currencies
            ? _value._currencies
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<CurrencyEntity> currencies)
...
abstract class _Loaded implements CurrencyState {
  const factory _Loaded(final List<CurrencyEntity> currencies) = _$LoadedImpl;
